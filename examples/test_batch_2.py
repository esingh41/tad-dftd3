...
def test_batch_apnet_vs_tad_inter():
    ...
    pairwise_simple_Es = torch.cat(pairwise_simple_Es, dim=0) * 2
    #Multiplying by two because they correct for double counting in their code by multiplying by 0.5, but I am not overcounting
    ...
    print(apnet_intermolecular_disp_E)
